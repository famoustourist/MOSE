...
class OFTInjectedLinear(nn.Module):
    ...
    def __init__(
        ...
        assert self.in_features % r == 0, "in_features must be divisible by r"
    ...
    def forward(self, x):
        ...
        #filt = torch.mm(block_diagonal_matrix, fix_filt.to(dtype).T)
    ...
    **kwargs: Any,
    ...
    if temp==0:
        ...
        for layer in hparams.layers:
            #model.transformer.h[layer].mlp.c_proj = assign_oft(model.transformer.h[layer].mlp.c_proj, r=hparams.block)
