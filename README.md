...
The configuration files for MOSE are located in the `hparams/MOSE` folder. Please select the corresponding YAML file to perform model editing.

## Example
*The following example is adapted from the EasyEdit repository*:
```
from easyeditor import MOSEHyperParams
## Loading config from hparams/MOSE/gpt2-xl.yaml
hparams = MOSEHyperParams.from_hparams('./hparams/MOSE/gpt2-xl')
